...
Nonetheless, when we began to collate all the components, we did find some repetition of the same _kinds_ of components. However, organising and naming the components proved to be highly contentious.
