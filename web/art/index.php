<?php
	...
	$thePageRenderer->setThisPage( 2 ); // 2 = art
	$thePageRenderer->doHeader( '<link rel="stylesheet" type="text/css" media="all" href="art.css" />' );
?>
<div id="main-content">
	<div class="box">
		<h2>Foreword</h2>
...
<?php
	...
	$theGalleryListing->printList( -1 );

?>
		<p>I may add more galleries in future so be sure to check back here from time to time!</p>
	</div>
</div>
